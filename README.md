...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/toyplot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9532&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/toyplot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `toyplot` can be installed with:

```
conda install toyplot
```

It is possible to list all of the versions of `toyplot` available on your platform with:
